...
class DashboardApp:
    ...
    def render_weather(self):
        ...
        color = (100, 200, 255) if temp < 20 else (255, 150, 50)
    ...
    def render_spotify(self, spotify):
        ...
        self.display.draw_text_centered("SPOTIFY", 32, self.font_path, 9, fill=(30, 215, 96))
        self.display.draw_line(45, margin=30, fill=(30, 215, 96))
    ...
    def render_printer(self, printer):
        ...
        # Cabeçalho
        self.display.draw_text_centered("K1 MAX", 10, self.font_path, 14, fill=(255, 140, 0))
        ...
        if state in ["PRINTING", "PAUSED"]:
            ...
            self.display.draw_text_centered(f"{progress_pct}%", 45, self.font_path, 42, fill=(255, 255, 255))
